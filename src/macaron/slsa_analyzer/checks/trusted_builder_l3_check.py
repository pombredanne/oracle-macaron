...
class TrustedBuilderL3Check(BaseCheck):
    ...
    def run_check(self, ctx: AnalyzeContext) -> CheckResultData:
            ...
            for callee in ci_info["callgraph"].bfs():
                ...
                if workflow_name in trusted_builders:
                    ...
                    if ctx.dynamic_data["is_inferred_prov"]:
                        ...
                        inferred_provenances.append(SLSAProvenanceData(asset=VirtualReleaseAsset(name="No_ASSET", url="NO_URL", size_in_bytes=0), payload=InTotoV01Payload(statement=provenance)))
        ...
        return CheckResultData(
            exit_justification=["Could not find a trusted level 3 builder as a GitHub Actions workflow."],
